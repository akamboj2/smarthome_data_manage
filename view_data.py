...
# in_filename = '/home/abhi/research/SmartHome/Data/youhome_mp4_data/mp4data/p101/Cook.Usemicrowave/00101_c4s0.h264'
in_filename = '/home/abhi/research/SmartHome/Data/youhome_mp4_data/mp4data/p104/Eat.Snack/00104_c1s0.h264'
...
print("probe\n", p)
# n_frames = int(p['streams'][0]['nb_frames']) # throwing an error
###############################################
...
while(True):
    ...
    print("in_frame!!!!\n\n\n",in_frame[0].shape, height,width)
    #Display the frame
    cv2.imshow('in_frame', in_frame)

    if cv2.waitKey(100) & 0xFF == ord('q'):
        break
    # process.stdout.flush() # close stdin (flush and send EOF)

# process.stdout.close() #AK
process.wait()
